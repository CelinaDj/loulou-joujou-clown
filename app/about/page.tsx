...
export const metadata: Metadata = {
  ...
  description:
    "Découvrez l'histoire de Loulou & Joujou Clown, notre expérience et notre univers artistique. Plus de 5 ans d'animation festive professionnelle.",
}
    ...
    <div className="container mx-auto py-12 px-4 md:px-6">
      ...
      <section className="grid md:grid-cols-2 gap-12 items-center mb-16">
        ...
        <div>
          ...
          <p className="mb-4">
          Loulou & Joujou Clown puise ses racines il y a plus de cinqs ans au sein de l’association culturelle TUSNA de notre village Amarat Commune Barbacha, wilaya Béjaia où deux artistes passionnés ont découvert l’art du clown et de l’animation pour enfants. C’est là que nos premiers sourires sont nés, et que l’étincelle de notre duo a pris vie.
          </p>
          <p className="mb-4">
...
<section className="mb-16">
  ...
  <div className="grid md:grid-cols-2 gap-12">
    ...
    <div className="bg-gray-50 p-6 rounded-xl">
      ...
      <p className="mb-4">
        Depuis 2019, Loulou &amp; Joujou Clown forment un duo complice et égalitaire. Étudiante titulaire
      ...
      <div className="flex items-center gap-2 text-[#cebe29]">
        ...
        <span className="font-medium">
          Spécialité : Développement digital, maquillage artistique & jeux d'intélligence 
        </span>
      </div>
    </div>
    ...
    <div className="bg-gray-50 p-6 rounded-xl">
      ...
      <p className="text-muted-foreground mb-4">Co‑fondatrice & Clown</p>
      <p className="mb-4">
        Depuis 2019, Loulou &amp; Joujou Clown forment un duo complice et égalitaire. Actuellement
