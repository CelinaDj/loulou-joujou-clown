...
export const metadata: Metadata = {
  ...
  description:
    "Découvrez nos différentes formules d'animation pour anniversaires, mariages et événements d'entreprise. Tarifs et prestations détaillés.",
}
    ...
    <div className="container mx-auto py-12 px-4 md:px-6">
      <div className="text-center mb-12">
        ...
        <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
          Découvrez nos différentes formules adaptées à tous types d'événements. Des animations sur mesure pour créer
      ...
      <div className="grid gap-12">
        <section>
          <h2 className="text-3xl font-bold mb-8 text-center">Formules Anniversaires</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <Card className="flex flex-col border-2 border-[#c184c2]">
              <CardHeader>
                <CardTitle className="text-2xl">Formule Étoile</CardTitle>
                <CardDescription>Idéale pour les petits groupes</CardDescription>
              </CardHeader>
              <CardContent className="flex-grow">
                <div className="text-4xl font-bold mb-6">150€</div>
                <ul className="space-y-2">
                  <li className="flex items-start">
                    <Check className="h-5 w-5 text-[#c184c2] mr-2 mt-0.5" />
                    <span>1 heure d'animation</span>
                  </li>
                  <li className="flex items-start">
                    <Check className="h-5 w-5 text-[#c184c2] mr-2 mt-0.5" />
            ...
            <Card className="flex flex-col border-2 border-[#FFED4A] relative">
              ...
              <CardHeader>
                <CardTitle className="text-2xl">Formule Magique</CardTitle>
                <CardDescription>Notre formule la plus demandée</CardDescription>
              </CardHeader>
              <CardContent className="flex-grow">
                <div className="text-4xl font-bold mb-6">250€</div>
                <ul className="space-y-2">
                  <li className="flex items-start">
                    <Check className="h-5 w-5 text-[#c184c2] mr-2 mt-0.5" />
                    <span>2 heures d'animation</span>
                  </li>
                  <li className="flex items-start">
                    <Check className="h-5 w-5 text-[#c184c2] mr-2 mt-0.5" />
                  ...
                  <li className="flex items-start">
                    <Check className="h-5 w-5 text-[#c184c2] mr-2 mt-0.5" />
                    <span>Jeux, maquillage et ballons</span>
                  </li>
                  <li className="flex items-start">
                    <Check className="h-5 w-5 text-[#c184c2] mr-2 mt-0.5" />
            ...
            <Card className="flex flex-col border-2">
              <CardHeader>
                <CardTitle className="text-2xl">Formule Royale</CardTitle>
              ...
              <CardContent className="flex-grow">
                ...
                <ul className="space-y-2">
                  <li className="flex items-start">
                    <Check className="h-5 w-5 text-[#c184c2] mr-2 mt-0.5" />
                    <span>3 heures d'animation</span>
                  </li>
                  <li className="flex items-start">
                    <Check className="h-5 w-5 text-[#c184c2] mr-2 mt-0.5" />
                    <span>2 clowns animateurs</span>
        ...
        <section>
          <h2 className="text-3xl font-bold mb-8 text-center">Mariages & Événements d'entreprise</h2>
          <p className="text-center mb-8 max-w-3xl mx-auto">
            Pour les mariages et événements d'entreprise, nous proposons des formules sur mesure adaptées à vos besoins
          ...
          <div className="bg-gray-50 p-8 rounded-xl max-w-3xl mx-auto">
            ...
            <ul className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <li className="flex items-start">
                <Check className="h-5 w-5 text-[#c184c2] mr-2 mt-0.5" />
                <span>Sculptures de ballons</span>
              </li>
              <li className="flex items-start">
                <Check className="h-5 w-5 text-[#c184c2] mr-2 mt-0.5" />
